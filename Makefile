...
build_web:
	docker run --volume ${PWD}/web:/web -w /web --volume /etc/passwd:/etc/passwd:ro --volume /etc/group:/etc/group:ro node:16 /bin/bash -c "npm install npm@8.19.1 && npm install && npm run build"
